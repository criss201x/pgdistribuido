...
create table asignaturas(
    ...
    int_h int not null check (int_h between 1 and 4),
...
create table estudiantes(
    cod_e bigint constraint pk_cod_e primary key check (cod_e>20247500000),
    nom_e varchar(75) not null,
    dir_e varchar(60) not null,
    tel_e bigint null check (tel_e>1000000000),
    id_carr int not null check (id_carr>11000),
    fech_nac date not null check (fech_nac between '1/01/1970' and '31/12/2009'),
...
create table inscribe(
    cod_e bigint constraint rf_estudiantes references estudiantes (cod_e) check (cod_e>20247500000),
    id_p int not null check (id_p>10000),
...
create table profesores(
    id_p int constraint pk_id_p primary key check (id_p>10000),
