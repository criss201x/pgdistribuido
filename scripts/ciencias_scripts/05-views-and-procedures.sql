...
create or replace view estudiante_fac_ciencias as
    select e.cod_e, e.nom_e, a.cod_a, a.nom_a, i.n1, i.n2, i.n3, (i.n1*0.35 + i.n2*0.35 + i.n3*0.30) as nota,
...
create or replace view profesor_fac_ciencias as
